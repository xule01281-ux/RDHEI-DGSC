function [recover_I,recovery_info] = retest_recover(image_encrypt_I,Image_key,ref_data,AI_sum_num,bit_max,image_test,LSIb,image_encrypt_I1,PFA_END,ecc,origin_D_I,PFA,asw,trandot,select_blocked1,r,origin_E_I,trandot1,key,iv,scrambleMap,has_opt_header)
