...
function [image_test,image_encrypt_I,emD,emD1,exD,validation,crypto,recover_I] = Encrypt_Embed(origin_I,D,Image_key,Data_key,ref_x,ref_y,h,w,prediction_mode,crypto)
